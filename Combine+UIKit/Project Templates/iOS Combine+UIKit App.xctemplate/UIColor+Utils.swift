...
extension UIColor {
    ...
    static let darkPupleBackground = UIColor(red:0.22, green:0.17, blue:0.18, alpha:1.00)
    static let navigationBarColor = UIColor(red:0.17, green:0.14, blue:0.18, alpha:1.00)
    static let defaultRed = UIColor(red:1.00, green:0.31, blue:0.06, alpha:1.00)
    static let defaultBlue = UIColor(red:0.20, green:0.84, blue:1.00, alpha:1.00)
